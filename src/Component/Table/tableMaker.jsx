        ...
        <div className={styles["paginateBlock"]}>
          ...
          <div className={styles["block-right"]}>
            <div className={styles["sizeButton"]}>
              <select className={styles["sizeSelect"]} aria-label="selector" onChange={SliceBy}> 
            ...
            <div className={styles["paginate"]}>
              ...
              {currentPage === 1 ? null : <button onClick={() => previousPage()}><svg className={styles['svg']} aria-label="previous button" height="1em" viewBox="0 0 512 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/></svg></button>}
              ...
              {currentPage === totalPage ? null : <button onClick={() => nextPage()} ><svg className={styles["svg"]} aria-label="next button" height="16" viewBox="0 0 512 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg></button>}
